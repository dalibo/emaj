...
echo "	E- pg 9.1 (port $PGPORT91) standart test"
...
echo "	T- pg 9.1 (port $PGPORT91) starting with E-Maj migration"
echo "	U- pg 9.2 (port $PGPORT92) starting with E-Maj migration"
