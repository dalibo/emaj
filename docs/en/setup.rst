...
.. caution::
   ...
   It is not mandatory to execute the installation script as *SUPERUSER*. But if it is not the case, some functionnalities are missing, depending on the effective rights owned by the installer role. These limitations ant their mitigations are :ref:`detailed here<non_superuser_install_limits>`.
