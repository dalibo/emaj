...
--
-- This script migrates an existing  0.10.1 installation of E-Maj extension.
--
...
--                                --
------------------------------------
-- Execute a procedure to check the migration conditions are met.
...
-- execute a procedure to lock all tables from logging groups
...
-- Note that emaj_mark table is altered later, after emaj functions have been changed.
...
ALTER EXTENSION emaj DROP FUNCTION emaj._start_groups(TEXT[],TEXT,BOOLEAN,BOOLEAN);
...
ALTER EXTENSION emaj DROP FUNCTION emaj._set_mark_groups(v_groupNames TEXT[], v_mark TEXT);
...
ALTER EXTENSION emaj DROP FUNCTION emaj.emaj_snap_log_group(v_groupName TEXT, v_firstMark TEXT, v_lastMark TEXT, v_dir TEXT);
...
ALTER EXTENSION emaj DROP TABLE emaj.emaj_mark_old;
DROP TABLE emaj.emaj_mark_old;

-- drop the emaj_tmp temporary table
ALTER EXTENSION emaj DROP TABLE emaj.emaj_tmp;
