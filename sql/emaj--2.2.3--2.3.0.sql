--
-- E-Maj: migration from 2.2.3 to 2.3.0
--
...
UPDATE emaj.emaj_param SET param_value_text = '2.3.0' WHERE param_key = 'emaj_version';

-- insert the upgrade record in the operation history
INSERT INTO emaj.emaj_hist (hist_function, hist_object, hist_wording) VALUES ('EMAJ_INSTALL','E-Maj 2.3.0', 'Upgrade from 2.2.3 completed');
