--
-- E-Maj: migration from 3.3.0 to 3.4.0
--
...
INSERT INTO emaj.emaj_hist (hist_function, hist_event, hist_object, hist_wording)
  VALUES ('EMAJ_INSTALL','BEGIN','E-Maj 3.4.0', 'Upgrade from 3.3.0 started');
...
UPDATE emaj.emaj_param SET param_value_text = '3.4.0' WHERE param_key = 'emaj_version';
ALTER TABLE emaj.emaj_param ENABLE TRIGGER emaj_param_change_trg;

-- insert the upgrade end record in the operation history
INSERT INTO emaj.emaj_hist (hist_function, hist_event, hist_object, hist_wording)
  VALUES ('EMAJ_INSTALL','END','E-Maj 3.4.0', 'Upgrade from 3.3.0 completed');
