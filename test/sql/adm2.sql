...
-- log tables
select "phil's col11", "phil's col12", "phil\s col13", emaj_verb, emaj_tuple, emaj_gid from emaj."phil's schema3_phil's tbl1_log" order by emaj_gid, emaj_tuple desc;
