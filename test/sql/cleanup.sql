...
revoke all on schema mySchema1, mySchema2, "phil's schema3", mySchema4 from emaj_regression_tests_adm_user;
...
-----------------------------
revoke all on schema mySchema1, mySchema2, "phil's schema3", mySchema4 from emaj_regression_tests_viewer_user;
