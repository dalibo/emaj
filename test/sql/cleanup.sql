...
revoke all on "phil's schema3".table_with_very_looooooooooooooooooooooooooooooooooooooong_name, "phil's schema3"."myTbl2\", "phil's schema3".myTbl4 from emaj_regression_tests_adm_user;
...
revoke all on "phil's schema3".table_with_very_looooooooooooooooooooooooooooooooooooooong_name, "phil's schema3"."myTbl2\" from emaj_regression_tests_viewer_user;
