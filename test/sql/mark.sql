...
select mark_id, mark_name, mark_group, mark_is_targetable, mark_is_rlbk_protected from emaj.emaj_mark where mark_group = 'myGroup1';
...
select emaj.emaj_protect_mark_group('myGroup1','EMAJ_LAST_MARK');
select regexp_replace(mark_name,E'\\d\\d\.\\d\\d\\.\\d\\d\\.\\d\\d\\d','%','g'), mark_is_targetable, mark_is_rlbk_protected 
